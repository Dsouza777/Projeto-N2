// iso27001/questionario.js
// Template base: behavior, autosave, dropdown conformidade, obs condicional, next/prev, validation

const secoes = [
  { titulo: "1. Escopo", descricao: "Define o escopo do SGSI.", obrigatorio: true, camposExtras: ["Responsável pela seção", "Data de revisão"], sub: [] },
  { titulo: "4. Contexto da Organização", descricao: "Entendimento do contexto, partes interessadas e escopo do SGSI.", obrigatorio: true, camposExtras: ["Notas internas"], sub: [
      { titulo: "4.1 Entendendo a organização e seu contexto", descricao: "", obrigatorio: true },
      { titulo: "4.2 Necessidades e expectativas das partes interessadas", descricao: "", obrigatorio: true }
    ]
  },
  { titulo: "5. Liderança", descricao: "Responsabilidades da direção e papéis.", obrigatorio: true, camposExtras: ["Documento de Política"], sub: [] },
  { titulo: "6. Planejamento", descricao: "Planejamento, riscos e objetivos de segurança.", obrigatorio: true, camposExtras: [], sub: [] },
  { titulo: "Anexo A — Controles (amostra)", descricao: "Controles de exemplo.", obrigatorio: false, camposExtras: [], sub: [
      { titulo: "A.5 Controles Organizacionais", obrigatorio: false },
      { titulo: "A.6 Controles de Pessoas", obrigatorio: false }
    ]
  }
];

const STORAGE_KEY = "iso27001_questionario_v1";
